 ...
 */
class m180629_002658_create_goods_spec_table extends Migration
{
    const TBL_NAME = '{{%goods_spec}}';
    ...
    public function up()
    {
        ...
        if ($this->db->driverName === 'mysql') {
            ...
            $tableOptions = 'CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci ENGINE=InnoDB COMMENT="商品规格"';
        }

        $this->createTable(self::TBL_NAME, [
            'id' => $this->primaryKey(),
            'goods_id' => $this->integer()->notNull()->defaultValue(0)->comment('相关商品ID'),
            'name' => $this->string()->notNull()->defaultValue('')->comment('规格名称'),
