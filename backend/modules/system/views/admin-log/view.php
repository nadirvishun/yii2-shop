...
/* @var $model backend\modules\system\models\AdminLog */
        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    ...
                    'value' => \backend\modules\system\models\Admin::getUsernameOptions($model->admin_id)
                ],
                [
                    'label' => $model->getAttributeLabel('type'),
                    'value' => \backend\modules\system\models\AdminLog::getTypeOptions($model->type)
                ],
                'model',
                'controller',
                'action',
